...
public class VagrantNoteSupplementRecipe extends CustomRecipe {

    public VagrantNoteSupplementRecipe(CraftingBookCategory category) {
        super(category);
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return TARecipes.VAGRANT_NOTE_SUPPLEMENT_SERIALIZER.get();
    }

...
public class TABlocks {
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_STONE = simpleBuilder("aurorian_stone", defaultStoneProperties(2.0F)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_EROSIVE = simpleBuilder("aurorian_erosive", defaultStoneProperties(2.0F)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_STONE_BRICKS = simpleBuilder("aurorian_stone_bricks", defaultStoneProperties(2.0F)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_COBBLESTONE = simpleBuilder("aurorian_cobblestone", defaultStoneProperties(2.0F)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_GRANITE = simpleBuilder("aurorian_granite", defaultStoneProperties(2.0F)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_DIORITE = simpleBuilder("aurorian_diorite", defaultStoneProperties(2.0F)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_ANDESITE = simpleBuilder("aurorian_andesite", defaultStoneProperties(2.0F)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_BARRIER_STONE = simpleBuilder("aurorian_barrier_stone", ofFullCopy(Blocks.BEDROCK)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().defaultBlockstate().register();
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_PORTAL_FRAME_BRICKS = simpleBuilder("aurorian_portal_frame_bricks", defaultStoneProperties(2.0F)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> MYSTERIUM_WOOL = simpleBuilder("mysterium_wool", ofFullCopy(Blocks.WHITE_WOOL)).tag(BlockTags.WOOL).defaultLoot().register();
    ...
    public static final DeferredHolder<Block, TALightDoublePlantBlock> TALL_AURORIAN_GRASS_LIGHT = registerNoItemBuilder("tall_aurorian_grass_light", p -> new TALightDoublePlantBlock(ofFullCopy(Blocks.TALL_GRASS)))
            .blockstate((ctx, prov) -> registerDoubleLightPlantStates(ctx.get(), prov)).item().model((ctx, prov) -> crossingBlockItem(ctx.get().getBlock(), prov, "_upper")).build().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> SMOOTH_AURORIAN_PERIDOTITE = simpleBuilder("smooth_aurorian_peridotite", defaultStoneProperties(5.0F)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_PERIDOTITE = simpleBuilder("aurorian_peridotite", defaultStoneProperties(5.0F)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> RUNE_STONE = runestoneBuilder("rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK, TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> SMOOTH_RUNE_STONE = runestoneBuilder("smooth_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK, TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CHISELED_RUNE_STONE = runestoneBuilder("chiseled_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_CASTLE_RUNE_STONE = runestoneBuilder("aurorian_castle_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> MOONSILVER_CASTLE_RUNE_STONE = runestoneBuilder("moonsilver_castle_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CERULEAN_CASTLE_RUNE_STONE = runestoneBuilder("cerulean_castle_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CRYSTALLINE_CASTLE_RUNE_STONE = runestoneBuilder("crystalline_castle_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> MOON_CASTLE_RUNE_STONE = runestoneBuilder("moon_castle_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> TRANSPARENT_RUNE_STONE = runestoneBuilder("transparent_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> UMBRA_CASTLE_RUNE_STONE = runestoneBuilder("umbra_castle_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> LUMINOUS_AURORIAN_CASTLE_RUNE_STONE = runestoneBuilder("luminous_aurorian_castle_rune_stone", of().noOcclusion()).tag(TABlockTags.RUNE_STONE_BLOCK).blockstate((ctx, prov) -> registerLuminousStates(ctx.get(), AURORIAN_CASTLE_RUNE_STONE.get(), prov)).register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> LUMINOUS_MOONSILVER_CASTLE_RUNE_STONE = runestoneBuilder("luminous_moonsilver_castle_rune_stone", of().noOcclusion()).tag(TABlockTags.RUNE_STONE_BLOCK).blockstate((ctx, prov) -> registerLuminousStates(ctx.get(), MOONSILVER_CASTLE_RUNE_STONE.get(), prov)).register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> LUMINOUS_CERULEAN_CASTLE_RUNE_STONE = runestoneBuilder("luminous_cerulean_castle_rune_stone", of().noOcclusion()).tag(TABlockTags.RUNE_STONE_BLOCK).blockstate((ctx, prov) -> registerLuminousStates(ctx.get(), CERULEAN_CASTLE_RUNE_STONE.get(), prov)).register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> LUMINOUS_CRYSTALLINE_CASTLE_RUNE_STONE = runestoneBuilder("luminous_crystalline_castle_rune_stone", of().noOcclusion()).tag(TABlockTags.RUNE_STONE_BLOCK).blockstate((ctx, prov) -> registerLuminousStates(ctx.get(), CRYSTALLINE_CASTLE_RUNE_STONE.get(), prov)).register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> LUMINOUS_MOON_CASTLE_RUNE_STONE = runestoneBuilder("luminous_moon_castle_rune_stone", of().noOcclusion()).tag(TABlockTags.RUNE_STONE_BLOCK).blockstate((ctx, prov) -> registerLuminousStates(ctx.get(), MOON_CASTLE_RUNE_STONE.get(), prov)).register();
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> MOON_TEMPLE_BRICKS = runestoneBuilder("moon_temple_bricks", of()).tag(TABlockTags.MOON_TEMPLE_BLOCKS, TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> DARK_STONE_BRICKS = runestoneBuilder("dark_stone_bricks", of()).tag(TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> DARK_STONE_FANCY = runestoneBuilder("dark_stone_fancy", of()).tag(TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> DARK_STONE_LAYERS = runestoneBuilder("dark_stone_layers", of()).tag(TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> SMOOTH_DARK_STONE_BRICKS = runestoneBuilder("smooth_dark_stone_bricks", of()).tag(TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CHISELED_DARK_STONE_BRICKS = runestoneBuilder("chiseled_dark_stone_bricks", of()).tag(TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> SMOOTH_MOON_TEMPLE_BRICKS = runestoneBuilder("smooth_moon_temple_bricks", of()).tag(TABlockTags.MOON_TEMPLE_BLOCKS, TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CHISELED_MOON_TEMPLE_BRICKS = runestoneBuilder("chiseled_moon_temple_bricks", of()).tag(TABlockTags.MOON_TEMPLE_BLOCKS, TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> RUNE_STONE_LAMP = runestoneBuilder("rune_stone_lamp", of().lightLevel(s -> 15)).tag(TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> DARK_STONE_LAMP = runestoneBuilder("dark_stone_lamp", of().lightLevel(s -> 15)).tag(TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> MOON_TEMPLE_LAMP = runestoneBuilder("moon_temple_lamp", of().lightLevel(s -> 15)).tag(TABlockTags.MOON_TEMPLE_BLOCKS, TABlockTags.AUROTIAN_ANIMAL_UNSPAWNABLE_ON).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> VOID_STONE = runestoneBuilder("void_stone", of().lightLevel(s -> 7)).defaultBlockstate().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> RUNE_CRYSTAL = runestoneBuilder("rune_crystal", of().lightLevel(s -> 3)).defaultBlockstate().register();
    ...
    public static final DeferredHolder<Block, DungeonStoneGateKeyhole> MOON_TEMPLE_CELL_GATE_KEYHOLE = registerBuilder("moon_temple_cell_gate_keyhole", p -> new DungeonStoneGateKeyhole(p, TAItems.MOON_TEMPLE_CELL_KEY, MOON_TEMPLE_CELL_GATE))
            .tag(TABlockTags.DUNGEON_BLOCKS, TABlockTags.MOON_TEMPLE_BLOCKS).defaultLoot().blockstate((ctx, prov) -> registerKeyholeStates(ctx.get(), prov)).register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CERULEAN_BLOCK = simpleBuilder("cerulean_block", defaultStoneProperties(3.0F).mapColor(MapColor.METAL)).tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_IRON_TOOL).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> MOONSTONE_BLOCK = simpleBuilder("moonstone_block", defaultStoneProperties(3.0F).mapColor(MapColor.METAL)).tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_IRON_TOOL).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> AURORIAN_COAL_BLOCK = simpleBuilder("aurorian_coal_block", defaultStoneProperties(5.0F).mapColor(MapColor.METAL)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> MOONSILVER_BLOCK = simpleBuilder("moonsilver_block", defaultStoneProperties(5.0F).mapColor(MapColor.METAL)).tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_IRON_TOOL).defaultLoot().register();
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> INDIGO_MUSHROOM_CRYSTAL = simpleBuilder("indigo_mushroom_crystal", of().mapColor(MapColor.COLOR_PURPLE).sound(SoundType.GLASS).lightLevel(s -> 1)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> MOON_SANDSTONE = simpleBuilder("moon_sandstone", ofFullCopy(Blocks.SANDSTONE)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CUT_MOON_SANDSTONE = simpleBuilder("cut_moon_sandstone", ofFullCopy(Blocks.CUT_SANDSTONE)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> SMOOTH_MOON_SANDSTONE = simpleBuilder("smooth_moon_sandstone", ofFullCopy(Blocks.SMOOTH_SANDSTONE)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> BRIGHT_MOON_SANDSTONE = simpleBuilder("bright_moon_sandstone", ofFullCopy(Blocks.SANDSTONE)).tag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> UMBRA_STONE = simpleBuilder("umbra_stone", defaultStoneProperties(5.0F)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> UMBRA_STONE_CRACKED = simpleBuilder("umbra_stone_cracked", defaultStoneProperties(5.0F)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> UMBRA_STONE_ROOF_TILES = simpleBuilder("umbra_stone_roof_tiles", defaultStoneProperties(5.0F)).tag(BlockTags.MINEABLE_WITH_PICKAXE).defaultLoot().register();
    ...
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> SILENT_TREE_PLANKS = simpleBuilder("silent_tree_planks", ofFullCopy(Blocks.OAK_PLANKS)).tag(TABlockTags.AURORIAN_PLANKS).defaultLoot().item().tag(TAItemTags.AURORIAN_PLANKS).build().register();
    ...
    public static final DeferredHolder<Block, Block> WEEPING_WILLOW_LEAVES = registerNoItemBuilder("weeping_willow_leaves", p -> Blocks.leaves(SoundType.GRASS)).tag(BlockTags.LEAVES)
            .blockstate((ctx, prov) -> simpleBlockWithRenderType(ctx.get(), CUTOUT_MIPPED, prov)).item().model((ctx, prov) -> prov.simpleBlockItem(ctx.get().getBlock())).build().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> WEEPING_WILLOW_PLANKS = simpleBuilder("weeping_willow_planks", ofFullCopy(Blocks.OAK_PLANKS)).tag(TABlockTags.AURORIAN_PLANKS).defaultLoot().item().tag(TAItemTags.AURORIAN_PLANKS).build().register();
    ...
    public static final DeferredHolder<Block, Block> CURTAIN_TREE_LEAVES = registerNoItemBuilder("curtain_tree_leaves", p -> Blocks.leaves(SoundType.GRASS)).tag(BlockTags.LEAVES)
            .blockstate((ctx, prov) -> simpleBlockWithRenderType(ctx.get(), CUTOUT_MIPPED, prov)).item().model((ctx, prov) -> prov.simpleBlockItem(ctx.get().getBlock())).build().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CURTAIN_TREE_PLANKS = simpleBuilder("curtain_tree_planks", ofFullCopy(Blocks.OAK_PLANKS)).tag(TABlockTags.AURORIAN_PLANKS).defaultLoot().item().tag(TAItemTags.AURORIAN_PLANKS).build().register();
    ...
    public static final DeferredHolder<Block, Block> CURSED_FROST_TREE_LEAVES = registerNoItemBuilder("cursed_frost_tree_leaves", p -> Blocks.leaves(SoundType.GRASS)).tag(BlockTags.LEAVES)
            .blockstate((ctx, prov) -> simpleBlockWithRenderType(ctx.get(), CUTOUT_MIPPED, prov)).item().model((ctx, prov) -> prov.simpleBlockItem(ctx.get().getBlock())).build().register();
    public static final DeferredHolder<Block, HidesNeighborFaceBlock> CURSED_FROST_TREE_PLANKS = simpleBuilder("cursed_frost_tree_planks", ofFullCopy(Blocks.OAK_PLANKS)).tag(TABlockTags.AURORIAN_PLANKS).defaultLoot().item().tag(TAItemTags.AURORIAN_PLANKS).build().register();

...
public class AurorianSteelShovel extends ShovelItem implements GeoItem {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public AurorianSteelShovel(Properties properties) {
        super(TAToolTiers.AURORIAN_STEEL, properties);
    }

    @Override
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoHandheldToolRenderer<AurorianSteelShovel>(TAItems.AURORIAN_STEEL_SHOVEL.getId()));
    }

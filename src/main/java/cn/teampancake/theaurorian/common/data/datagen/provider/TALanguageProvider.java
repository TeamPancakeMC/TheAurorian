...
public class TALanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.addEffect(TAMobEffects.TEMP_SHIELD, "Temp Shield", "临时护盾");
        ...
        //MOD ENCHANTMENT
        this.addEnchantment(TAEnchantments.IMPALE.get().getDescriptionId(), "Impale", "刺穿",
        ...
        this.add(TAPaintingVariants.createDescriptionId(TAPaintingVariants.PROGRESSION.get()), "Progression", "前进");
        this.add(TAPaintingVariants.createDescriptionId(TAPaintingVariants.DUNGEON.get()), "Dungeon", "地牢");
        this.add(TAPaintingVariants.createDescriptionId(TAPaintingVariants.KEEPER.get()), "Keeper", "守卫");
        this.add(TAPaintingVariants.createDescriptionId(TAPaintingVariants.KNIGHT.get()), "Knight", "骑士");
        this.add(TAPaintingVariants.createDescriptionId(TAPaintingVariants.MOON.get()), "Moon", "皎月");
        this.add(TAPaintingVariants.createDescriptionId(TAPaintingVariants.PORTAL.get()), "Portal", "传送门");
        this.add(TAPaintingVariants.createDescriptionId(TAPaintingVariants.SLIME.get()), "Slime", "史莱姆");
    ...
    private void addEnchantment(String key, String en, String cn, String description_en, String description_cn) {
       this.add(key,en,cn);

...
public class MoonsilverBow extends BowItem implements GeoItem {
    ...
    public MoonsilverBow(Properties properties) {
        super(properties);
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoHandheldToolRenderer<MoonsilverBow>(TAItems.MOONSILVER_BOW.getId()));
    }

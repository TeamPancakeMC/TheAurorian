...
public class MysteriumWoolArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partDefinition.addOrReplaceChild("bipedHeadwear", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        partDefinition.addOrReplaceChild("bipedRightArm", CubeListBuilder.create()
        ...
        partDefinition.addOrReplaceChild("bipedLeftArm", CubeListBuilder.create()
        ...
        partDefinition.addOrReplaceChild("bipedRightLeg", CubeListBuilder.create()
        ...
        partDefinition.addOrReplaceChild("bipedLeftLeg", CubeListBuilder.create()

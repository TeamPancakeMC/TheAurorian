...
public class TALanguageProviderZHCN extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(TAItems.RUNESTONE_ICE.get(), "寒冰符石");
        this.add(TAItems.RUNESTONE_LIFE.get(), "生命符石");
        this.add(TAItems.RUNESTONE_LIGHT.get(), "光明符石");
        this.add(TAItems.RUNESTONE_WATER.get(), "水流符石");
        this.add(TAItems.RUNESTONE_BLAZE.get(), "烈焰符石");
        this.add(TAItems.RUNESTONE_THUNDER.get(), "雷电符石");
        this.add(TAItems.RUNESTONE_DARKNESS.get(), "黑暗符石");

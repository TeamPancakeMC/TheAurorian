...
public class TALanguageProviderZHCN extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(TABlocks.VERTICAL_AURORIAN_STONE_SLAB.get(), "竖极光石楼梯");
        this.add(TABlocks.VERTICAL_AURORIAN_STONE_BRICK_SLAB.get(), "竖极光石砖楼梯");
        this.add(TABlocks.VERTICAL_AURORIAN_COBBLESTONE_SLAB.get(), "竖极光圆石楼梯");
        this.add(TABlocks.VERTICAL_SILENT_WOOD_SLAB.get(), "竖谧木楼梯");
        this.add(TABlocks.VERTICAL_RUNE_STONE_SLAB.get(), "竖符石楼梯");
        this.add(TABlocks.VERTICAL_SMOOTH_RUNE_STONE_SLAB.get(), "竖平滑符石楼梯");
        this.add(TABlocks.VERTICAL_CHISELED_RUNE_STONE_SLAB.get(), "竖雕纹符石楼梯");
        this.add(TABlocks.VERTICAL_AURORIAN_CASTLE_RUNE_STONE_SLAB.get(), "竖极光符文符石楼梯");
        this.add(TABlocks.VERTICAL_AURORIAN_STEEL_CASTLE_RUNE_STONE_SLAB.get(), "竖极光钢符文符石楼梯");
        this.add(TABlocks.VERTICAL_CERULEAN_CASTLE_RUNE_STONE_SLAB.get(), "竖晶蓝符文符石楼梯");
        this.add(TABlocks.VERTICAL_CRYSTALLINE_CASTLE_RUNE_STONE_SLAB.get(), "竖月凝晶符文符石楼梯");
        this.add(TABlocks.VERTICAL_MOON_CASTLE_RUNE_STONE_SLAB.get(), "竖皎月符文符石楼梯");
        this.add(TABlocks.VERTICAL_LUMINOUS_AURORIAN_CASTLE_RUNE_STONE_SLAB.get(), "竖发光极光符文符石楼梯");
        this.add(TABlocks.VERTICAL_LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_SLAB.get(), "竖发光极光钢符文符石楼梯");
        this.add(TABlocks.VERTICAL_LUMINOUS_CERULEAN_CASTLE_RUNE_STONE_SLAB.get(), "竖发光晶蓝符文符石楼梯");
        this.add(TABlocks.VERTICAL_LUMINOUS_CRYSTALLINE_CASTLE_RUNE_STONE_SLAB.get(), "竖发光月凝晶符文符石楼梯");
        this.add(TABlocks.VERTICAL_LUMINOUS_MOON_CASTLE_RUNE_STONE_SLAB.get(), "竖发光皎月符文符石楼梯");
        this.add(TABlocks.VERTICAL_TRANSPARENT_RUNE_STONE_SLAB.get(), "竖透明符石楼梯");
        this.add(TABlocks.VERTICAL_UMBRA_CASTLE_RUNE_STONE_SLAB.get(), "竖本影符文符石楼梯");
        this.add(TABlocks.VERTICAL_DARK_STONE_BRICK_SLAB.get(), "竖暗石楼梯");
        this.add(TABlocks.VERTICAL_SMOOTH_DARK_STONE_BRICK_SLAB.get(), "竖平滑暗石砖块楼梯");
        this.add(TABlocks.VERTICAL_CHISELED_DARK_STONE_BRICK_SLAB.get(), "竖雕纹暗石砖块楼梯");
        this.add(TABlocks.VERTICAL_MOON_TEMPLE_BRICK_SLAB.get(), "竖月宫楼梯");
        this.add(TABlocks.VERTICAL_SMOOTH_MOON_TEMPLE_BRICK_SLAB.get(), "竖平滑月宫楼梯");
        this.add(TABlocks.VERTICAL_CHISELED_MOON_TEMPLE_BRICK_SLAB.get(), "竖雕纹月宫楼梯");
        this.add(TABlocks.VERTICAL_UMBRA_STONE_SLAB.get(), "竖本影石楼梯");
        this.add(TABlocks.VERTICAL_UMBRA_STONE_CRACKED_SLAB.get(), "竖裂纹本影石楼梯");
        this.add(TABlocks.VERTICAL_UMBRA_STONE_ROOF_SLAB.get(), "竖本影石瓦楼梯");
        this.add(TABlocks.VERTICAL_WEEPING_WILLOW_SLAB.get(), "竖垂柳木楼梯");
        this.add(TABlocks.VERTICAL_AURORIAN_PERIDOTITE_SLAB.get(), "竖极光橄榄岩楼梯");
        this.add(TABlocks.VERTICAL_SMOOTH_AURORIAN_PERIDOTITE_SLAB.get(), "竖平滑极光橄榄岩楼梯");

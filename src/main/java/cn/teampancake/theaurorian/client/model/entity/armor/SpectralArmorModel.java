...
public class SpectralArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bipedRightArm.addOrReplaceChild("bright_arm_r6", CubeListBuilder.create().texOffs(57, 18).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.5F, -0.5F, 0.0F, 0.0F, 0.0F, -0.4363F));

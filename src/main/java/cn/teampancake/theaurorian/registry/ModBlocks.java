...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> LAVENDER_PLANT = BLOCKS.register("lavender_plant", () -> new AbstractPlantBlock(copy(Blocks.GRASS), AURORIAN_GRASS_BLOCK));
    public static final RegistryObject<Block> PETUNIA_PLANT = BLOCKS.register("petunia_plant", () -> new AbstractPlantBlock(copy(Blocks.GRASS), AURORIAN_GRASS_BLOCK));
    public static final RegistryObject<Block> SILK_BERRY_PLANT = BLOCKS.register("silk_berry_plant", () -> new AbstractPlantBlock(copy(Blocks.GRASS), AURORIAN_GRASS_BLOCK));
    ...
    public static final RegistryObject<Block> SILENT_WOOD_WALL_TORCH = register("silent_wood_wall_torch", () -> new WallTorchBlock(copy(Blocks.WALL_TORCH), ParticleTypes.FLAME));

...
public class RunestoneKeeperModel<T extends RunestoneKeeper> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition shield = left_arm.addOrReplaceChild("shield", CubeListBuilder.create().texOffs(74, 0).addBox(0.5F, -4.0F, -4.0F, 1.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
        ...
        shield2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(56, 48).addBox(0.0F, -3.0F, -3.0F, 0.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
        ...
        right_arm.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(32, 34).addBox(-0.8F, -1.0F, -0.2F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-1.5F, 4.0F, 0.0F, -0.0873F, -1.0036F, -0.1745F));
        ...
        wand.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(34, 60).addBox(-2.5F, 0.0F, -2.0F, 5.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, 0.0F, -11.5F, 0.0F, 0.0F, 1.5708F));
        PartDefinition wand_1 = wand.addOrReplaceChild("wand_1", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -11.0F));
        wand_1.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(53, 42).addBox(-0.5F, -2.5F, -5.0F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)),
        ...
        wand_2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(53, 42).addBox(-2.0F, -2.5F, -3.0F, 4.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 1.5708F));
        PartDefinition head = body_all.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -7.5F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, -12.0F, 0.0F));
        head.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(32, 34).addBox(0.0F, -1.0F, -2.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-4.0F, -4.0F, 3.0F, -0.6545F, -0.5236F, 0.48F));
        head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(32, 34).addBox(-1.0F, -1.0F, -1.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-4.0F, -4.0F, 3.0F, 0.0F, -1.1345F, 0.3491F));
        head.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 33).addBox(-3.0F, -3.0F, -4.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(5.0F, -3.5F, -2.0F, 0.0F, 0.5672F, -0.1309F));
        PartDefinition hat = head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(72, 49).addBox(-7.0F, 0.0F, -7.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -7.5F, 0.0F, -0.1745F, 0.0F, 0.0873F));
        hat.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(112, 14).addBox(-2.0F, -5.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -7.0F, 3.0F, -0.7854F, 0.0F, 0.0F));
        hat.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(104, 24).addBox(-3.0F, -2.3F, -2.0F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -5.5F, 0.0F, -0.3491F, 0.0F, 0.0F));
        hat.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(88, 35).addBox(-5.0F, -4.0F, -5.0F, 10.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, -0.0873F, 0.0F, 0.0F));
        head.addOrReplaceChild("head_2", CubeListBuilder.create().texOffs(56, 60).addBox(-5.0F, -6.0F, -4.5F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),

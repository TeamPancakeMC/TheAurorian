...
public class TASoundEvents {
    ...
    public static final RegistryObject<SoundEvent> SNOW_TUNDRA_GIANT_CRAB_AMBIENT = register("snow_tundra_giant_crab/ambient");
    public static final RegistryObject<SoundEvent> SNOW_TUNDRA_GIANT_CRAB_STEP = register("snow_tundra_giant_crab/step");
    public static final RegistryObject<SoundEvent> SNOW_TUNDRA_GIANT_CRAB_HURT = register("snow_tundra_giant_crab/hurt");
    public static final RegistryObject<SoundEvent> SNOW_TUNDRA_GIANT_CRAB_DEATH = register("snow_tundra_giant_crab/death");

...
public class TABlocks {
    ...
    public static Properties runestoneProperties(Properties properties) {
        return properties.mapColor(MapColor.STONE).instrument(NoteBlockInstrument.BASEDRUM).requiresCorrectToolForDrops()
                .destroyTime(-1.0F).explosionResistance(3600000.0F).requiredFeatures(TAFeatureFlags.DUNGEON);
    }

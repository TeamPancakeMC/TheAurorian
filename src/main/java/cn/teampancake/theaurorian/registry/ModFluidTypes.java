...
import cn.teampancake.theaurorian.common.blocks.fluids.BaseFluidType;
...
public class ModFluidTypes {
    ...
    public static final RegistryObject<FluidType> MOLTEN_AURORIAN_STEEL = FLUID_TYPES.register("molten_aurorian_steel",
            () -> new BaseFluidType(defaultProperties(), AurorianMod.prefix("blocks/molten_aurorian_steel"),
                    AurorianMod.prefix("blocks/molten_aurorian_steel_flowing")));
    public static final RegistryObject<FluidType> MOLTEN_CERULEAN = FLUID_TYPES.register("molten_cerulean",
            () -> new BaseFluidType(defaultProperties(), AurorianMod.prefix("blocks/molten_cerulean"),
                    AurorianMod.prefix("blocks/molten_cerulean_flowing")));
    public static final RegistryObject<FluidType> MOLTEN_MOONSTONE = FLUID_TYPES.register("molten_moonstone",
            () -> new BaseFluidType(defaultProperties(), AurorianMod.prefix("blocks/molten_moonstone"),
                    AurorianMod.prefix("blocks/molten_moonstone_flowing")));
    public static final RegistryObject<FluidType> MOON_WATER = FLUID_TYPES.register("moon_water",
            () -> new BaseFluidType(FluidType.Properties.create(), AurorianMod.prefix("blocks/moon_water"),
                    AurorianMod.prefix("blocks/moon_water_flowing")));

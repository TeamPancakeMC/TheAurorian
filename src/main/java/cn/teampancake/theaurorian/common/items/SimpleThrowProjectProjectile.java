...
public class SimpleThrowProjectProjectile extends Item implements ITooltipsItem {
    ...
    public SimpleThrowProjectProjectile(Properties properties, SoundEvent soundEvent, SoundSource soundSource, EntityType<?> projectile, float velocity, float inaccuracy) {
        super(properties);
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide && this.projectile.create(level) instanceof ThrowableItemProjectile itemProjectile) {

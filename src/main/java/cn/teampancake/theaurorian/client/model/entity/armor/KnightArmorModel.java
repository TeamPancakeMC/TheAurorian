...
public class KnightArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bipedBody.addOrReplaceChild("body_r2", CubeListBuilder.create().texOffs(65, 45).mirror().addBox(-3.25F, -1.25F, -2.5F, 4.0F, 13.0F, 5.0F, new CubeDeformation(-0.005F)).mirror(false), PartPose.offsetAndRotation(4.0F, 11.0F, 0.0F, 0.0F, 0.0F, -0.1309F));
        bipedBody.addOrReplaceChild("body_r3", CubeListBuilder.create().texOffs(48, 45).mirror().addBox(-1.75F, -2.25F, -2.5F, 3.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, 11.0F, 0.0F, 0.0F, 0.0F, -0.3491F));
        bipedBody.addOrReplaceChild("body_r4", CubeListBuilder.create().texOffs(65, 45).addBox(-0.75F, -1.25F, -2.5F, 4.0F, 13.0F, 5.0F, new CubeDeformation(-0.005F)), PartPose.offsetAndRotation(-4.0F, 11.0F, 0.0F, 0.0F, 0.0F, 0.1309F));
        bipedBody.addOrReplaceChild("body_r5", CubeListBuilder.create().texOffs(48, 45).addBox(-1.25F, -2.25F, -2.5F, 3.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 11.0F, 0.0F, 0.0F, 0.0F, 0.3491F));

...
public class SpiderlingModel<T extends Spiderling> extends HierarchicalModel<T> {
    ...
    public SpiderlingModel(ModelPart root) {
        ...
        this.head = this.all.getChild("body").getChild("bone4").getChild("head");
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = all.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, 0.0F));
        PartDefinition bone4 = body.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -3.0F, -4.0F, 7.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        PartDefinition bone = bone4.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 3.0F));
        bone.addOrReplaceChild("cube_r1", CubeListBuilder.create()
                ...
                .texOffs(0, 23).addBox(-4.5F, -4.5F, -1.0F, 9.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3054F, 0.0F, 0.0F));
        PartDefinition head = bone4.addOrReplaceChild("head", CubeListBuilder.create().texOffs(29, 4).addBox(-2.5F, -2.5F, -3.0F, 5.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.75F, -4.0F));
        head.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(41, 6).addBox(-1.5F, 0.0F, -3.5F, 3.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, 0.25F, -2.5F));
        head.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(41, 6).mirror().addBox(-1.5F, 0.0F, -3.5F, 3.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(2.5F, 0.25F, -2.5F));
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(SpiderlingAnimation.WALK, limbSwing, limbSwingAmount, (1.0F), (2.5F));
        this.animate(entity.idleAnimationState, SpiderlingAnimation.IDLE, ageInTicks);
        this.animate(entity.attackAnimationState, SpiderlingAnimation.ATTACK, ageInTicks);
    }

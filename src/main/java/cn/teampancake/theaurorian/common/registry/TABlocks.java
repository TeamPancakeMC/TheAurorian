...
public class TABlocks {
    ...
    public static final DeferredHolder<Block, Block> AURORIAN_EROSIVE = normal("aurorian_erosive", defaultStoneProperties(2.0F).addBlockTag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).isSimpleModelBlock().useSimpleBlockItem());
    ...
    public static final DeferredHolder<Block, Block> AURORIAN_GRANITE = normal("aurorian_granite", defaultStoneProperties(2.0F).addBlockTag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).lootType(TALootType.SELF).isSimpleModelBlock().useSimpleBlockItem());
    public static final DeferredHolder<Block, Block> AURORIAN_DIORITE = normal("aurorian_diorite", defaultStoneProperties(2.0F).addBlockTag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).lootType(TALootType.SELF).isSimpleModelBlock().useSimpleBlockItem());
    public static final DeferredHolder<Block, Block> AURORIAN_ANDESITE = normal("aurorian_andesite", defaultStoneProperties(2.0F).addBlockTag(TABlockTags.AURORIAN_CARVER_REPLACEABLES, BlockTags.MINEABLE_WITH_PICKAXE).lootType(TALootType.SELF).isSimpleModelBlock().useSimpleBlockItem());
    ...
    public static final DeferredHolder<Block, Block> AURORIAN_GRASS_BLOCK = register("aurorian_grass_block", () -> new AurorianGrassBlock(ofFullCopy(Blocks.GRASS_BLOCK).mapColor(MapColor.COLOR_LIGHT_BLUE).addBlockTag(TABlockTags.AURORIAN_GRASS_BLOCK).useSimpleBlockItem()));
    public static final DeferredHolder<Block, Block> LIGHT_AURORIAN_GRASS_BLOCK = register("light_aurorian_grass_block", () -> new AurorianGrassBlock(ofFullCopy(Blocks.GRASS_BLOCK).mapColor(MapColor.TERRACOTTA_WHITE).addBlockTag(TABlockTags.AURORIAN_GRASS_BLOCK).lightLevel(s -> 2).useSimpleBlockItem()));
    public static final DeferredHolder<Block, Block> SNOW_AURORIAN_GRASS_BLOCK = register("snow_aurorian_grass_block", () -> new AurorianGrassBlock(ofFullCopy(Blocks.GRASS_BLOCK).mapColor(MapColor.SNOW).addBlockTag(TABlockTags.AURORIAN_GRASS_BLOCK).useSimpleBlockItem()));
    public static final DeferredHolder<Block, Block> RED_AURORIAN_GRASS_BLOCK = register("red_aurorian_grass_block", () -> new AurorianGrassBlock(ofFullCopy(Blocks.GRASS_BLOCK).mapColor(MapColor.COLOR_RED).addBlockTag(TABlockTags.AURORIAN_GRASS_BLOCK).useSimpleBlockItem()));
    ...
    public static final DeferredHolder<Block, Block> LUMINOUS_AURORIAN_CASTLE_RUNE_STONE = normal("luminous_aurorian_castle_rune_stone", dungeonBlockProperties().addBlockTag(TABlockTags.RUNE_STONE_BLOCK).useSimpleBlockItem().noOcclusion());
    public static final DeferredHolder<Block, Block> LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE = normal("luminous_aurorian_steel_castle_rune_stone", dungeonBlockProperties().addBlockTag(TABlockTags.RUNE_STONE_BLOCK).useSimpleBlockItem().noOcclusion());
    public static final DeferredHolder<Block, Block> LUMINOUS_CERULEAN_CASTLE_RUNE_STONE = normal("luminous_cerulean_castle_rune_stone", dungeonBlockProperties().addBlockTag(TABlockTags.RUNE_STONE_BLOCK).useSimpleBlockItem().noOcclusion());
    public static final DeferredHolder<Block, Block> LUMINOUS_CRYSTALLINE_CASTLE_RUNE_STONE = normal("luminous_crystalline_castle_rune_stone", dungeonBlockProperties().addBlockTag(TABlockTags.RUNE_STONE_BLOCK).useSimpleBlockItem().noOcclusion());
    public static final DeferredHolder<Block, Block> LUMINOUS_MOON_CASTLE_RUNE_STONE = normal("luminous_moon_castle_rune_stone", dungeonBlockProperties().addBlockTag(TABlockTags.RUNE_STONE_BLOCK).useSimpleBlockItem().noOcclusion());
    ...
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_AURORIAN_CASTLE_RUNE_STONE_STAIRS = verticalStair("vertical_luminous_aurorian_castle_rune_stone_stairs", AURORIAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_STAIRS = verticalStair("vertical_luminous_aurorian_steel_castle_rune_stone_stairs", AURORIAN_STEEL_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_CERULEAN_CASTLE_RUNE_STONE_STAIRS = verticalStair("vertical_luminous_cerulean_castle_rune_stone_stairs", CERULEAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_CRYSTALLINE_CASTLE_RUNE_STONE_STAIRS = verticalStair("vertical_luminous_crystalline_castle_rune_stone_stairs", CRYSTALLINE_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_MOON_CASTLE_RUNE_STONE_STAIRS = verticalStair("vertical_luminous_moon_castle_rune_stone_stairs", MOON_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    ...
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_AURORIAN_CASTLE_RUNE_STONE_SLAB = verticalSlab("vertical_luminous_aurorian_castle_rune_stone_slab", AURORIAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_SLAB = verticalSlab("vertical_luminous_aurorian_steel_castle_rune_stone_slab", AURORIAN_STEEL_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_CERULEAN_CASTLE_RUNE_STONE_SLAB = verticalSlab("vertical_luminous_cerulean_castle_rune_stone_slab", CERULEAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_CRYSTALLINE_CASTLE_RUNE_STONE_SLAB = verticalSlab("vertical_luminous_crystalline_castle_rune_stone_slab", CRYSTALLINE_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> VERTICAL_LUMINOUS_MOON_CASTLE_RUNE_STONE_SLAB = verticalSlab("vertical_luminous_moon_castle_rune_stone_slab", MOON_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    ...
    public static final DeferredHolder<Block, Block> LUMINOUS_AURORIAN_CASTLE_RUNE_STONE_STAIRS = stair("luminous_aurorian_castle_rune_stone_stairs", AURORIAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_STAIRS = stair("luminous_aurorian_steel_castle_rune_stone_stairs", AURORIAN_STEEL_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_CERULEAN_CASTLE_RUNE_STONE_STAIRS = stair("luminous_cerulean_castle_rune_stone_stairs", CERULEAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_CRYSTALLINE_CASTLE_RUNE_STONE_STAIRS = stair("luminous_crystalline_castle_rune_stone_stairs", CRYSTALLINE_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_MOON_CASTLE_RUNE_STONE_STAIRS = stair("luminous_moon_castle_rune_stone_stairs", MOON_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    ...
    public static final DeferredHolder<Block, Block> LUMINOUS_AURORIAN_CASTLE_RUNE_STONE_SLAB = slab("luminous_aurorian_castle_rune_stone_slab", AURORIAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_SLAB = slab("luminous_aurorian_steel_castle_rune_stone_slab", AURORIAN_STEEL_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_CERULEAN_CASTLE_RUNE_STONE_SLAB = slab("luminous_cerulean_castle_rune_stone_slab", CERULEAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_CRYSTALLINE_CASTLE_RUNE_STONE_SLAB = slab("luminous_crystalline_castle_rune_stone_slab", CRYSTALLINE_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_MOON_CASTLE_RUNE_STONE_SLAB = slab("luminous_moon_castle_rune_stone_slab", MOON_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity());
    ...
    public static final DeferredHolder<Block, Block> LUMINOUS_AURORIAN_CASTLE_RUNE_STONE_WALL = wall("luminous_aurorian_castle_rune_stone_wall", AURORIAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_WALL = wall("luminous_aurorian_steel_castle_rune_stone_wall", AURORIAN_STEEL_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_CERULEAN_CASTLE_RUNE_STONE_WALL = wall("luminous_cerulean_castle_rune_stone_wall", CERULEAN_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_CRYSTALLINE_CASTLE_RUNE_STONE_WALL = wall("luminous_crystalline_castle_rune_stone_wall", CRYSTALLINE_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity().hasEmissivity());
    public static final DeferredHolder<Block, Block> LUMINOUS_MOON_CASTLE_RUNE_STONE_WALL = wall("luminous_moon_castle_rune_stone_wall", MOON_CASTLE_RUNE_STONE, dungeonBlockProperties().hasEmissivity().hasEmissivity());

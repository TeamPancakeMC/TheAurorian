...
@OnlyIn(Dist.CLIENT)
public class MoonsilverArmorModel extends HumanoidModel<LivingEntity> {

    public MoonsilverArmorModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bipedBody.addOrReplaceChild("cube_r1", CubeListBuilder.create()
        ...
        bipedBody.addOrReplaceChild("cube_r2", CubeListBuilder.create()
                .texOffs(38, 53).mirror().addBox(-2.85F, 1.5F, -2.55F, 3.0F, 5.0F, 5.0F, new CubeDeformation(-0.003F)).mirror(false)
        ...
        bipedBody.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(55, 55).addBox(-3.0F, -0.25F, 0.15F, 6.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 9.5F, 2.325F, 0.0873F, 0.0F, 0.0F));
        ...
        bipedRightArm.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 43).addBox(-2.5F, -4.0F, -3.0F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));
        ...
        bipedLeftArm.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 43).mirror().addBox(-1.5F, -4.0F, -3.0F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));

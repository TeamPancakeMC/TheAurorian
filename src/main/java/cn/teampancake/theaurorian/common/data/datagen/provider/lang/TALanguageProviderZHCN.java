...
public class TALanguageProviderZHCN extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(TABlocks.DREAMSCAPE_PISTIL.get(), "梦境之蕊");
        this.add(TABlocks.FROST_TEARS_FLOWER.get(), "霜泪花");
        ...
        this.add(TABlocks.CRISPED_MALLOW.get(), "冬葵");
        this.add(TABlocks.FROST_SNOW_GRASS.get(), "霜雪草");
        ...
        this.add(TAMobEffects.DEAFNESS.get(), "失聪");
        ...
        this.add(TAMobEffects.MOON_BEFALL.get(), "月临");
        this.add(TAMobEffects.BLESS_OF_MOON.get(), "护月");
        this.add(TAMobEffects.POTION_REMAIN.get(), "药水残留");
        this.add(TAMobEffects.EIDOLON_POISON.get(), "幻光毒");
        this.add(TAMobEffects.CRYSTALLIZATION.get(), "晶化");

...
import cn.teampancake.theaurorian.config.Config;
...
public class AurorianMod
{
    ...
    public static final RegistryObject<CreativeModeTab> AURORIAN_TAB = CREATIVE_TAB.register("The Aurorian", () -> CreativeModeTab.builder()

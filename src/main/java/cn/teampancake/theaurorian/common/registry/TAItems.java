...
public class TAItems {
     ...
     * Materials
     */
    public static final DeferredHolder<Item, Item> RAW_CERULEAN = normal("raw_cerulean", Item.Properties::new);
    public static final DeferredHolder<Item, Item> RAW_MOONSTONE = normal("raw_moonstone", Item.Properties::new);
    public static final DeferredHolder<Item, Item> AURORIAN_COAL = normal("aurorian_coal", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> AURORIANITE_INGOT = normal("aurorianite_ingot", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> AURORIAN_STEEL = normal("aurorian_steel", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC));
    public static final DeferredHolder<Item, Item> CERULEAN_INGOT = normal("cerulean_ingot", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> CRYSTALLINE_INGOT = normal("crystalline_ingot", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> MOONSTONE_INGOT = normal("moonstone_ingot", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> UMBRA_INGOT = normal("umbra_ingot", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> LAVENDER = normal("lavender", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> PLANT_FIBER = normal("plant_fiber", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> AURORIANITE_SCRAP = normal("aurorianite_scrap", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> CRYSTALLINE_SCRAP = normal("crystalline_scrap", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> UMBRA_SCRAP = normal("umbra_scrap", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> SPECTRAL_SILK = normal("spectral_silk", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> DARK_AMULET = normal("dark_amulet", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> DUNGEON_KEEPER_AMULET = normal("dungeon_keeper_amulet", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
     ...
     * SwordItem
     */
    public static final DeferredHolder<Item, Item> AURORIAN_STEEL_DAGGER = ITEMS.register("aurorian_steel_dagger", AurorianSteelDagger::new);
     ...
     * ShovelItem
     */
    public static final DeferredHolder<Item, Item> AURORIAN_STEEL_SHOVEL = ITEMS.register("aurorian_steel_shovel", () -> new ShovelItem(TAToolTiers.AURORIAN_STEEL, new Item.Properties().attributes(
            ShovelItem.createAttributes(TAToolTiers.AURORIAN_STEEL, 1.5F, -3.0F)).component(TADataComponents.ITEM_TAGS, List.of(ItemTags.SHOVELS)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.UNCOMMON)));
    public static final DeferredHolder<Item, Item> AURORIAN_STONE_SHOVEL = ITEMS.register("aurorian_stone_shovel", () -> new ShovelItem(TAToolTiers.AURORIAN_STONE, new Item.Properties().attributes(
            ShovelItem.createAttributes(TAToolTiers.AURORIAN_STONE, 1.5F, -3.0F)).component(TADataComponents.ITEM_TAGS, List.of(ItemTags.SHOVELS)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.UNCOMMON)));
     ...
     * HoeItem
     */
    public static final DeferredHolder<Item, Item> AURORIAN_STEEL_HOE = ITEMS.register("aurorian_steel_hoe", () -> new HoeItem(TAToolTiers.AURORIAN_STEEL, new Item.Properties().attributes(
            HoeItem.createAttributes(TAToolTiers.AURORIAN_STEEL, -2, -1.0F)).component(TADataComponents.ITEM_TAGS, List.of(ItemTags.HOES)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC)));
    public static final DeferredHolder<Item, Item> AURORIAN_STONE_HOE = ITEMS.register("aurorian_stone_hoe", () -> new HoeItem(TAToolTiers.AURORIAN_STONE, new Item.Properties().attributes(
            HoeItem.createAttributes(TAToolTiers.AURORIAN_STONE, -2, -1.0F)).component(TADataComponents.ITEM_TAGS, List.of(ItemTags.HOES)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC)));
    public static final DeferredHolder<Item, Item> SILENT_WOOD_HOE = ITEMS.register("silent_wood_hoe", () -> new HoeItem(TAToolTiers.SILENT_WOOD, new Item.Properties().attributes(
            HoeItem.createAttributes(TAToolTiers.SILENT_WOOD, -2, -1.0F)).component(TADataComponents.ITEM_TAGS, List.of(ItemTags.HOES)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC)));
    public static final DeferredHolder<Item, Item> MOONSTONE_HOE = ITEMS.register("moonstone_hoe", () -> new HoeItem(TAToolTiers.SILENT_WOOD, new Item.Properties().attributes(
            HoeItem.createAttributes(TAToolTiers.SILENT_WOOD, -2, -1.0F)).component(TADataComponents.ITEM_TAGS, List.of(ItemTags.HOES)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC)));
    ...
    public static final DeferredHolder<Item, Item> SILENT_WOOD_SICKLE = ITEMS.register("silent_wood_sickle", () -> new ShearsItem(new Item.Properties()
            .durability(50).component(TADataComponents.ITEM_TAGS, List.of(ItemTags.DURABILITY_ENCHANTABLE, ItemTags.MINING_ENCHANTABLE))
            .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> AURORIAN_STONE_SICKLE = ITEMS.register("aurorian_stone_sickle", () -> new ShearsItem(new Item.Properties()
            .durability(150).component(TADataComponents.ITEM_TAGS, List.of(ItemTags.DURABILITY_ENCHANTABLE, ItemTags.MINING_ENCHANTABLE))
            .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    ...
    public static final DeferredHolder<Item, Item> MOONSTONE_SHIELD = ITEMS.register("moonstone_shield", () -> new ShieldItem(new Item.Properties()
            .component(TADataComponents.ITEM_TAGS, List.of(Tags.Items.TOOLS_SHIELD, ItemTags.DURABILITY_ENCHANTABLE))
            .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC).durability(512)));
    ...
    public static final DeferredHolder<Item, Item> SILENT_WOOD_BOW = ITEMS.register("silent_wood_bow", () -> new BowItem(new Item.Properties().durability(384)
            .component(TADataComponents.ITEM_TAGS, List.of(ItemTags.DURABILITY_ENCHANTABLE, ItemTags.BOW_ENCHANTABLE, Tags.Items.TOOLS_BOW)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC)));
     ...
     * Food
     */
    public static final DeferredHolder<Item, Item> TALL_WICK_GRASS = ITEMS.register("tall_wick_grass", () -> new DoubleHighBlockItem(
            TABlocks.TALL_WICK_GRASS.get(), new Item.Properties().component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> AURORIAN_BEEF = ITEMS.register("aurorian_beef", () -> new Item(
            new Item.Properties().food(Foods.BEEF).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> AURORIAN_PORK = ITEMS.register("aurorian_pork", () -> new Item(
            new Item.Properties().food(Foods.PORKCHOP).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> AURORIAN_MUTTON = ITEMS.register("aurorian_mutton", () -> new Item(
            new Item.Properties().food(Foods.MUTTON).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> AURORIAN_RABBIT = ITEMS.register("aurorian_rabbit", () -> new Item(
            new Item.Properties().food(Foods.RABBIT).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    ...
    public static final DeferredHolder<Item, Item> SILK_BERRY_JAM = food("silk_berry_jam", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 2, 0.5F);
    public static final DeferredHolder<Item, Item> SILK_BERRY_JAM_SANDWICH = food("silk_berry_jam_sandwich", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 6, 0.9F);
    public static final DeferredHolder<Item, Item> AURORIAN_SLIMEBALL = food("aurorian_slimeball", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 1, 0.2F);
    public static final DeferredHolder<Item, Item> SILK_SHROOM_STEW = food("silk_shroom_stew", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 6, 1F);
    public static final DeferredHolder<Item, Item> LAVENDER_BREAD = food("lavender_bread", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 4, 0.4F);
    public static final DeferredHolder<Item, Item> SOULLESS_FLESH = food("soulless_flesh", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 2, 0.1F);
    public static final DeferredHolder<Item, Item> MOON_FISH = food("moon_fish", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 2, 0.4F);
    public static final DeferredHolder<Item, Item> AURORIAN_WINGED_FISH = food("aurorian_winged_fish", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 2,0.4F);
    public static final DeferredHolder<Item, Item> COOKED_MOON_FISH = food("cooked_moon_fish", () -> new Item.Properties().component(TADataComponents.ITEM_TAGS, List.of(TAItemTags.COOKED_MEAT)), 5,6);
    public static final DeferredHolder<Item, Item> COOKED_AURORIAN_WINGED_FISH = food("cooked_aurorian_winged_fish", () -> new Item.Properties()
            .component(TADataComponents.ITEM_TAGS, List.of(TAItemTags.COOKED_MEAT)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE), 5,6);
    ...
    public static final DeferredHolder<Item, Item> SILK_BERRY = alias("silk_berry", TABlocks.SILK_BERRY_CROP, () -> new Item.Properties()
            .food(new FoodProperties.Builder().nutrition(1).saturationModifier(0.1F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE));
    public static final DeferredHolder<Item, Item> BLUEBERRY = alias("blueberry", TABlocks.BLUEBERRY_BUSH, () -> new Item.Properties().food(Foods.SWEET_BERRIES).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE));
    ...
    public static final DeferredHolder<Item, Item> CANDY_CANE = ITEMS.register("candy_cane", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.4F)
            .effect(() -> new MobEffectInstance(MobEffects.LUCK, 300), 1.0F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> GINGERBREAD_MAN = ITEMS.register("gingerbread_man", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.4F)
            .effect(() -> new MobEffectInstance(TAMobEffects.WARM, 1200), 1.0F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    ...
    public static final DeferredHolder<Item, Item> AURORIAN_BACON = ITEMS.register("aurorian_bacon", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.8F)
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 60), 1.0F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> STRANGE_MEAT = ITEMS.register("strange_meat", () -> new StrangeMeat(new Item.Properties().rarity(Rarity.EPIC).durability(10)
            .food(new FoodProperties.Builder().nutrition(8).saturationModifier(0.9F).alwaysEdible().build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> LAVENDER_SALAD = ITEMS.register("lavender_salad", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(4).saturationModifier(5.0F)
            .effect(() -> new MobEffectInstance(TAMobEffects.NATURE, 600), 1.0F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> FAKE_ALGAL_PIT_FISH = ITEMS.register("fake_algal_pit_fish", () -> new Item(new Item.Properties()
            .food(new FoodProperties.Builder().nutrition(4).saturationModifier(5.0F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> SASHIMI = ITEMS.register("sashimi", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(5).saturationModifier(0.1F)
            .effect(() -> new MobEffectInstance(MobEffects.LUCK, 400), 1.0F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> SILENT_WOOD_FRUIT = ITEMS.register("silent_wood_fruit", () -> new Item(new Item.Properties()
            .food(new FoodProperties.Builder().nutrition(3).saturationModifier(2.5F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    ...
    public static final DeferredHolder<Item, Item> AURORIAN_WINTER_ROOT = ITEMS.register("aurorian_winter_root", () -> new Item(new Item.Properties()
            .food(new FoodProperties.Builder().nutrition(1).saturationModifier(0.8F).build()).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> ROASTED_AURORIAN_WINTER_ROOT = ITEMS.register("roasted_aurorian_winter_root",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(4).saturationModifier(6.0F)
                    ...
                    .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> DARK_STONE_SHRIMP = ITEMS.register("dark_stone_shrimp",
     ...
     * Key
     */
    public static final DeferredHolder<Item, Item> MOON_TEMPLE_CELL_KEY_FRAGMENT = normal("moon_temple_cell_key_fragment",
            () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> RUNE_STONE_KEY = ITEMS.register("rune_stone_key", () -> new Item(new Item.Properties()
            .rarity(Rarity.UNCOMMON).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> DARK_STONE_KEY = ITEMS.register("dark_stone_key", () -> new Item(new Item.Properties()
            .rarity(Rarity.UNCOMMON).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> MOON_TEMPLE_KEY = ITEMS.register("moon_temple_key", () -> new Item(new Item.Properties()
            .rarity(Rarity.UNCOMMON).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> RUNE_STONE_LOOT_KEY = ITEMS.register("rune_stone_loot_key", () -> new Item(new Item.Properties()
            .rarity(Rarity.UNCOMMON).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> MOON_TEMPLE_CELL_KEY = ITEMS.register("moon_temple_cell_key", () -> new Item(new Item.Properties()
            .rarity(Rarity.UNCOMMON).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));

    /**
     * Arrow
     */
    public static final DeferredHolder<Item, Item> CERULEAN_ARROW = ITEMS.register("cerulean_arrow", 
            () -> new CeruleanArrow(new Item.Properties().component(TADataComponents.ITEM_TAGS, List.of(ItemTags.ARROWS))
                    .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> CRYSTAL_ARROW = ITEMS.register("crystal_arrow", 
            () -> new CrystalArrow(new Item.Properties().component(TADataComponents.ITEM_TAGS, List.of(ItemTags.ARROWS))
                    .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    ...
    public static final DeferredHolder<Item, Item> SILENT_WOOD_STICK = alias("silent_wood_stick", TABlocks.SILENT_WOOD_STICK, () -> new Item.Properties()
            .component(TADataComponents.ITEM_TAGS, List.of(Tags.Items.RODS_WOODEN)).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE));
     ...
     * Runestone
     */
    public static final DeferredHolder<Item, Item> RUNESTONE_ICE_1 = ITEMS.register("runestone_ice_1", () -> new IceRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_ICE, new RunestoneIce(0.1f, 0.3f, 1.0f)), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_ICE_2 = ITEMS.register("runestone_ice_2", () -> new IceRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_ICE, new RunestoneIce(0.1f, 0.3f, 1.5f)), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_ICE_3 = ITEMS.register("runestone_ice_3", () -> new IceRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_ICE, new RunestoneIce(0.31f, 0.5f, 1.5f)), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_ICE_4 = ITEMS.register("runestone_ice_4", () -> new IceRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_ICE, new RunestoneIce(0.31f, 0.5f, 2.0f)), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_ICE_5 = ITEMS.register("runestone_ice_5", () -> new IceRunestone(new Item.Properties()
    ...
    public static final DeferredHolder<Item, Item> RUNESTONE_LIFE_1 = ITEMS.register("runestone_life_1", () -> new LifeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIFE, new RunestoneLife(1, 6)).component(TADataComponents.FIXED_HEALTH_BOOST, 5.0F), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIFE_2 = ITEMS.register("runestone_life_2", () -> new LifeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIFE, new RunestoneLife(6, 11)).component(TADataComponents.FIXED_HEALTH_BOOST, 10.0F), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIFE_3 = ITEMS.register("runestone_life_3", () -> new LifeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIFE, new RunestoneLife(11, 16)).component(TADataComponents.FIXED_HEALTH_BOOST, 15.0F), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIFE_4 = ITEMS.register("runestone_life_4", () -> new LifeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIFE, new RunestoneLife(16, 21)).component(TADataComponents.FIXED_HEALTH_BOOST, 20.0F), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIFE_5 = ITEMS.register("runestone_life_5", () -> new LifeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIFE, new RunestoneLife(21, 26)).component(TADataComponents.FIXED_HEALTH_BOOST, 25.0F), 5));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIGHT_1 = ITEMS.register("runestone_light_1", () -> new LightRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIGHT, new RunestoneWater(0.1f, 0.2f, 1.0f)), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIGHT_2 = ITEMS.register("runestone_light_2", () -> new LightRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIGHT, new RunestoneWater(0.21f, 0.3f, 1.0f)), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIGHT_3 = ITEMS.register("runestone_light_3", () -> new LightRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIGHT, new RunestoneWater(0.21f, 0.3f, 2.0f)), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIGHT_4 = ITEMS.register("runestone_light_4", () -> new LightRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIGHT, new RunestoneWater(0.31f, 0.4f, 2.0f)), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_LIGHT_5 = ITEMS.register("runestone_light_5", () -> new LightRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_LIGHT, new RunestoneWater(1.0f, 1.0f, 2.0f)), 5));
    public static final DeferredHolder<Item, Item> RUNESTONE_WATER_1 = ITEMS.register("runestone_water_1", () -> new WaterRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_WATER, new RunestoneWater(0.1f, 0.2f, 1.0f)), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_WATER_2 = ITEMS.register("runestone_water_2", () -> new WaterRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_WATER, new RunestoneWater(0.21f, 0.3f, 1.0f)), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_WATER_3 = ITEMS.register("runestone_water_3", () -> new WaterRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_WATER, new RunestoneWater(0.25f, 0.35f, 2.0f)), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_WATER_4 = ITEMS.register("runestone_water_4", () -> new WaterRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_WATER, new RunestoneWater(0.36f, 0.5f, 2.0f)), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_WATER_5 = ITEMS.register("runestone_water_5", () -> new WaterRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_WATER, new RunestoneWater(1.0f, 1.0f, 2.0f)), 5));
    public static final DeferredHolder<Item, Item> RUNESTONE_BLAZE_1 = ITEMS.register("runestone_blaze_1", () -> new BlazeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_BLAZE, new RunestoneBlaze(0.2f, 0.3f, 0.01f, 0.1f)), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_BLAZE_2 = ITEMS.register("runestone_blaze_2", () -> new BlazeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_BLAZE, new RunestoneBlaze(0.3f, 0.4f, 0.11f, 0.2f)), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_BLAZE_3 = ITEMS.register("runestone_blaze_3", () -> new BlazeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_BLAZE, new RunestoneBlaze(0.3f, 0.4f, 0.21f, 0.3f)), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_BLAZE_4 = ITEMS.register("runestone_blaze_4", () -> new BlazeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_BLAZE, new RunestoneBlaze(0.4f, 0.6f, 0.31f, 0.4f)), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_BLAZE_5 = ITEMS.register("runestone_blaze_5", () -> new BlazeRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_BLAZE, new RunestoneBlaze(1.0f, 1.0f, 0.5f, 0.5f)), 5));
    public static final DeferredHolder<Item, Item> RUNESTONE_THUNDER_1 = ITEMS.register("runestone_thunder_1", () -> new ThunderRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_THUNDER, new RunestoneThunder(0.01f, 0.15f)), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_THUNDER_2 = ITEMS.register("runestone_thunder_2", () -> new ThunderRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_THUNDER, new RunestoneThunder(0.16f, 0.30f)), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_THUNDER_3 = ITEMS.register("runestone_thunder_3", () -> new ThunderRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_THUNDER, new RunestoneThunder(0.31f, 0.45f)), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_THUNDER_4 = ITEMS.register("runestone_thunder_4", () -> new ThunderRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_THUNDER, new RunestoneThunder(0.46f, 0.6f)), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_THUNDER_5 = ITEMS.register("runestone_thunder_5", () -> new ThunderRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_THUNDER, new RunestoneThunder(1.0f, 1.0f)), 5));
    public static final DeferredHolder<Item, Item> RUNESTONE_DARKNESS_1 = ITEMS.register("runestone_darkness_1", () -> new DarknessRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_DARKNESS, new RunestoneDarkness(0.4F, 0.5F, 0.15F, 0.25F)), 1, 3.0D));
    public static final DeferredHolder<Item, Item> RUNESTONE_DARKNESS_2 = ITEMS.register("runestone_darkness_2", () -> new DarknessRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_DARKNESS, new RunestoneDarkness(0.3F, 0.4F, 0.25F, 0.35F)), 2, 4.0D));
    public static final DeferredHolder<Item, Item> RUNESTONE_DARKNESS_3 = ITEMS.register("runestone_darkness_3", () -> new DarknessRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_DARKNESS, new RunestoneDarkness(0.3F, 0.4F, 0.35F, 0.5F)), 3, 5.0D));
    public static final DeferredHolder<Item, Item> RUNESTONE_DARKNESS_4 = ITEMS.register("runestone_darkness_4", () -> new DarknessRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_DARKNESS, new RunestoneDarkness(0.4F, 0.5F, 0.5F, 0.6F)), 4, 6.0D));
    public static final DeferredHolder<Item, Item> RUNESTONE_DARKNESS_5 = ITEMS.register("runestone_darkness_5", () -> new DarknessRunestone(new Item.Properties()
            .component(TADataComponents.RUNESTONE_DARKNESS, new RunestoneDarkness(1.0F, 1.0F, 0.6F, 0.7F)), 5, 6.0D));
    public static final DeferredHolder<Item, Item> RUNESTONE_STORM_1 = ITEMS.register("runestone_storm_1", () -> new StormRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_STORM, new RunestoneStorm(0.05F, 0.1F, 1.0f, 1.5f)).component(TADataComponents.FIXED_SPEED_BOOST, 0.1F), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_STORM_2 = ITEMS.register("runestone_storm_2", () -> new StormRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_STORM, new RunestoneStorm(0.1F, 0.15F, 2.0f, 1.5f)).component(TADataComponents.FIXED_SPEED_BOOST, 0.15F), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_STORM_3 = ITEMS.register("runestone_storm_3", () -> new StormRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_STORM, new RunestoneStorm(0.15F, 0.2F, 2.0f, 2.0f)).component(TADataComponents.FIXED_SPEED_BOOST, 0.2F), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_STORM_4 = ITEMS.register("runestone_storm_4", () -> new StormRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_STORM, new RunestoneStorm(0.2F, 0.3F, 3.0f, 2.0f)).component(TADataComponents.FIXED_SPEED_BOOST, 0.3F), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_STORM_5 = ITEMS.register("runestone_storm_5", () -> new StormRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_STORM, new RunestoneStorm(0.3F, 0.4F, 4.0f, 2.0f)).component(TADataComponents.FIXED_SPEED_BOOST, 0.4F), 5));
    public static final DeferredHolder<Item, Item> RUNESTONE_NATURE_1 = ITEMS.register("runestone_nature_1", () -> new NatureRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_NATURE, new RunestoneNature(0.25F, 0.35F, 0.1F, 0.2F)).component(TADataComponents.FIXED_CHOP_BOOST, 0.35F), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_NATURE_2 = ITEMS.register("runestone_nature_2", () -> new NatureRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_NATURE, new RunestoneNature(0.36F, 0.55F, 0.21F, 0.3F)).component(TADataComponents.FIXED_CHOP_BOOST, 0.55F), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_NATURE_3 = ITEMS.register("runestone_nature_3", () -> new NatureRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_NATURE, new RunestoneNature(0.56F, 0.75F, 0.31F, 0.4F)).component(TADataComponents.FIXED_CHOP_BOOST, 0.75F), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_NATURE_4 = ITEMS.register("runestone_nature_4", () -> new NatureRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_NATURE, new RunestoneNature(0.76F, 1.0F, 0.41F, 0.5F)).component(TADataComponents.FIXED_CHOP_BOOST, 1.0F), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_NATURE_5 = ITEMS.register("runestone_nature_5", () -> new NatureRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_NATURE, new RunestoneNature(1.01F, 1.5F, 0.51F, 0.6F)).component(TADataComponents.FIXED_CHOP_BOOST, 1.5F), 5));
    public static final DeferredHolder<Item, Item> RUNESTONE_MOUNTAIN_1 = ITEMS.register("runestone_mountain_1", () -> new MountainRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_MOUNTAIN, new RunestoneMountain(0.25F, 0.35F, 0.1F, 0.2F)).component(TADataComponents.FIXED_MINING_BOOST, 0.35F), 1));
    public static final DeferredHolder<Item, Item> RUNESTONE_MOUNTAIN_2 = ITEMS.register("runestone_mountain_2", () -> new MountainRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_MOUNTAIN, new RunestoneMountain(0.36F, 0.55F, 0.21F, 0.3F)).component(TADataComponents.FIXED_MINING_BOOST, 0.55F), 2));
    public static final DeferredHolder<Item, Item> RUNESTONE_MOUNTAIN_3 = ITEMS.register("runestone_mountain_3", () -> new MountainRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_MOUNTAIN, new RunestoneMountain(0.56F, 0.75F, 0.31F, 0.4F)).component(TADataComponents.FIXED_MINING_BOOST, 0.75F), 3));
    public static final DeferredHolder<Item, Item> RUNESTONE_MOUNTAIN_4 = ITEMS.register("runestone_mountain_4", () -> new MountainRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_MOUNTAIN, new RunestoneMountain(0.76F, 1.0F, 0.41F, 0.5F)).component(TADataComponents.FIXED_MINING_BOOST, 1.0F), 4));
    public static final DeferredHolder<Item, Item> RUNESTONE_MOUNTAIN_5 = ITEMS.register("runestone_mountain_5", () -> new MountainRunestone(new Item.Properties().component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE)
            .component(TADataComponents.RUNESTONE_MOUNTAIN, new RunestoneMountain(1.01F, 1.5F, 0.51F, 0.6F)).component(TADataComponents.FIXED_MINING_BOOST, 1.5F), 5));
    public static final DeferredHolder<Item, Item> RUNESTONE_MOON = ITEMS.register("runestone_moon", () -> new Runestone(new Item.Properties()
            .component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE).component(TADataComponents.ADVANCED_RUNESTONE, Unit.INSTANCE), 5));
    ...
    public static final DeferredHolder<Item, Item> CRYSTAL = normal("crystal", () -> new Item.Properties().component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE));
    public static final DeferredHolder<Item, Item> BROKEN_OX_HORN = normal("broken_ox_horn", Item.Properties::new);
    public static final DeferredHolder<Item, Item> LUCKY_RABBIT_EAR = normal("lucky_rabbit_ear", Item.Properties::new);
    ...
    public static final DeferredHolder<Item, Item> LOCK_PICKS = ITEMS.register("lock_picks", () -> new Item(new Item.Properties()
            .durability(10).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.EPIC).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> MOON_WATER_BUCKET = ITEMS.register("moon_water_bucket", () -> new BucketItem(TAFluids.MOON_WATER_STILL.get(),
            new Item.Properties().stacksTo(1).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> AURORIAN_WINGED_FISH_BUCKET = ITEMS.register("aurorian_winged_fish_bucket", () -> new MobBucketItem(
            ...
            .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.RARE).component(TADataComponents.SIMPLE_MODEL, Unit.INSTANCE)));
    public static final DeferredHolder<Item, Item> MOON_FISH_BUCKET = ITEMS.register("moon_fish_bucket", () -> new MobBucketItem(
     ...
     * Developer Item
     */
    public static final DeferredHolder<Item, Item> SLEEPING_BLACK_TEA = normal("sleeping_black_tea", () -> new Item.Properties()
    ...
    public static final DeferredHolder<Item, Item> WHITE_CHOCOLATE = normal("white_chocolate", () -> new Item.Properties()
    ...
    public static final DeferredHolder<Item, Item> RED_BOOK_RING = normal("red_book_ring", () -> new Item.Properties()
    ...
    public static final DeferredHolder<Item, Item> TSLAT_SWORD = ITEMS.register("tslat_sword",
            () -> new SwordItem(TAToolTiers.TSLAT, new Item.Properties()
                    ...
                    .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.TSLAT_SWORD)
                    .component(TADataComponents.ITEM_TAGS, List.of(ItemTags.SWORDS))
                    .component(TADataComponents.EXTRA_TOOLTIP, Unit.INSTANCE)
                    .component(TADataComponents.DEVELOPER, Unit.INSTANCE)
                    .component(TADataComponents.KILL_COUNT, 0)));
    ...
    public static final DeferredHolder<Item, Item> SILENT_WOOD_TORCH = ITEMS.register("silent_wood_torch", () -> new StandingAndWallBlockItem(
            TABlocks.SILENT_WOOD_TORCH.get(), TABlocks.SILENT_WOOD_WALL_TORCH.get(), new Item.Properties()
            .component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.UNCOMMON), Direction.DOWN));
    public static final DeferredHolder<Item, Item> SILENT_WOOD_SIGN = ITEMS.register("silent_wood_sign", () -> new SignItem(
            new Item.Properties().stacksTo(16).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.UNCOMMON),
            TABlocks.SILENT_WOOD_SIGN.get(), TABlocks.SILENT_WOOD_WALL_SIGN.get()));
    ...
    public static final DeferredHolder<Item, Item> SILENT_WOOD_HANGING_SIGN = ITEMS.register("silent_wood_hanging_sign", () -> new HangingSignItem(
            TABlocks.SILENT_WOOD_HANGING_SIGN.get(), TABlocks.SILENT_WOOD_WALL_HANGING_SIGN.get(), new Item.Properties()
            .stacksTo(16).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.UNCOMMON)));
    public static final DeferredHolder<Item, Item> WEEPING_WILLOW_WOOD_HANGING_SIGN = ITEMS.register("weeping_willow_wood_hanging_sign", () -> new HangingSignItem(
            TABlocks.WEEPING_WILLOW_WOOD_HANGING_SIGN.get(), TABlocks.WEEPING_WILLOW_WOOD_WALL_HANGING_SIGN.get(), new Item.Properties()
            .stacksTo(16).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.UNCOMMON)));
    public static final DeferredHolder<Item, Item> CURTAIN_WOOD_HANGING_SIGN = ITEMS.register("curtain_wood_hanging_sign", () -> new HangingSignItem(
            TABlocks.CURTAIN_WOOD_HANGING_SIGN.get(), TABlocks.CURTAIN_WOOD_WALL_HANGING_SIGN.get(), new Item.Properties()
            .stacksTo(16).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.UNCOMMON)));
    public static final DeferredHolder<Item, Item> CURSED_FROST_WOOD_HANGING_SIGN = ITEMS.register("cursed_frost_wood_hanging_sign", () -> new HangingSignItem(
            TABlocks.CURSED_FROST_WOOD_HANGING_SIGN.get(), TABlocks.CURSED_FROST_WOOD_WALL_HANGING_SIGN.get(), new Item.Properties()
            .stacksTo(16).component(TADataComponents.ITEM_TOOLTIP, TAItemTooltips.UNCOMMON)));

...
public class CeruleanArmorModel<T extends LivingEntity> extends TAHumanoidModel<T> {
    ...
    public static MeshDefinition createBodyLayer(CubeDeformation cubeDeformation) {
        ...
        bipedHead.addOrReplaceChild("bipedHead_r1", CubeListBuilder.create().texOffs(56, 23).addBox(-1.0F, -3.0F, -0.4F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.125F)), PartPose.offsetAndRotation(0.0F, -8.5F, -4.0F, -0.2182F, 0.0F, 0.0F));
        ...
        PartDefinition bipedBody = partDefinition.addOrReplaceChild("body", CubeListBuilder.create()
                ...
                .texOffs(19, 68).addBox(-2.5F, 9.55F, -2.35F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(19, 58).addBox(-3.0F, 8.8F, 2.4F, 6.0F, 9.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 45).addBox(-4.0F, 9.5F, -2.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.31F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        bipedRightArm.addOrReplaceChild("right_arm_r1", CubeListBuilder.create()
                .texOffs(17, 37).addBox(-5.5F, -3.0F, 0.0F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition rightLeg = partDefinition.addOrReplaceChild("right_leg", CubeListBuilder.create(), PartPose.offset(-3.0F, 11.0F, 0.0F));
        rightLeg.addOrReplaceChild("right_leg_r1", CubeListBuilder.create().texOffs(0, 52).mirror().addBox(-2.25F, -2.0F, -2.5F, 4.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1309F));
        PartDefinition leftLeg = partDefinition.addOrReplaceChild("left_leg", CubeListBuilder.create(), PartPose.offset(3.0F, 11.0F, 0.0F));
        leftLeg.addOrReplaceChild("left_leg_r1", CubeListBuilder.create().texOffs(0, 52).addBox(-1.75F, -2.0F, -2.5F, 4.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

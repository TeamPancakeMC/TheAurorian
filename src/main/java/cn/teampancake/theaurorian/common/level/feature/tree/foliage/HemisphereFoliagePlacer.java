...
public class HemisphereFoliagePlacer extends FoliagePlacer {
    ...
    public static final MapCodec<HemisphereFoliagePlacer> CODEC = RecordCodecBuilder.mapCodec((placer) -> foliagePlacerParts(placer).apply(placer, HemisphereFoliagePlacer::new));

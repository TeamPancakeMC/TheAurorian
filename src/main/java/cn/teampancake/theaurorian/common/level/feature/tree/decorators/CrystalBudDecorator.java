...
public class CrystalBudDecorator extends TreeDecorator {
    ...
    public static final MapCodec<CrystalBudDecorator> CODEC = Codec.floatRange(0.0F, 1.0F)
            .fieldOf("probability").xmap(CrystalBudDecorator::new, decorator -> decorator.probability);

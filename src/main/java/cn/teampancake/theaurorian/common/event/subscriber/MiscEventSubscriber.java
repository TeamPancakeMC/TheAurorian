...
import cn.teampancake.theaurorian.common.items.curio.runestone.LifeRunestone;
                ...
                if (item instanceof Runestone runestone) {
                    ...
                    if (lootChance > 0.0F) {
                        ...
                        if (runestone instanceof LifeRunestone lifeRunestone && runestoneLife != null) {
                            ...
                            LootItemConditionalFunction.Builder<?> setBoost = SetFixedHealthBoostFunction.setBoost(between);

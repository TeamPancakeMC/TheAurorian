...
public class TALanguageProviderZHCN extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(TABlocks.STRIPPED_CURTAIN_TREE_LOG.get(), "去皮幽帘原木");
        this.add(TABlocks.STRIPPED_CURTAIN_TREE_WOOD.get(), "去皮幽帘木头");
        this.add(TABlocks.CURTAIN_TREE_LEAVES.get(), "幽帘树叶");
        this.add(TABlocks.CURTAIN_TREE_PLANKS.get(), "幽帘木板");

...
public class UndeadKnightModel<T extends UndeadKnight> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.75F, 0.75F, 0.1745F, 0.0F, 0.0F));
        ...
        arm_right.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(21, 47)
                .addBox(0.0F, -4.0F, -2.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
        ...
        arm_right_1_1.addOrReplaceChild("weapon", CubeListBuilder.create()
        ...
        PartDefinition arm_left = body.addOrReplaceChild("arm_left", CubeListBuilder.create(), PartPose.offsetAndRotation(9.25F, -3.25F, 0.0F, 0.3646F, 0.2865F, 0.1074F));

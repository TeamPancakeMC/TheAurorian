...
public class AurorianSteelArmorModel<T extends LivingEntity> extends TAHumanoidModel<T> {
    ...
    public static MeshDefinition createBodyLayer(CubeDeformation cubeDeformation) {
        ...
        bipedHead.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(9, 37).addBox(-2.0F, -3.125F, 0.0F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, -3.0F, -4.515F, 0.0F, 0.5236F, 0.0F));
        bipedHead.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(9, 37).mirror().addBox(0.0F, -3.125F, 0.0F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.5F, -3.0F, -4.515F, 0.0F, -0.5236F, 0.0F));
        ...
        bipedBody.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(55, 55).addBox(-3.0F, -0.25F, 0.15F, 6.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 9.5F, 2.325F, 0.0873F, 0.0F, 0.0F));
        ...
        bipedRightArm.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 43).addBox(-2.5F, -4.0F, -3.0F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));
        ...
        bipedLeftArm.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 43).mirror().addBox(-1.5F, -4.0F, -3.0F, 4.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
        PartDefinition rightLeg = partDefinition.addOrReplaceChild("right_leg", CubeListBuilder.create(), PartPose.offset(-4.5F, 10.5F, 0.0F));
        rightLeg.addOrReplaceChild("cube_r4", CubeListBuilder.create()
                .texOffs(38, 53).addBox(-0.15F, 1.5F, -2.55F, 3.0F, 5.0F, 5.0F, new CubeDeformation(-0.003F))
                .texOffs(38, 53).addBox(-0.4F, -1.5F, -2.55F, 3.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1309F));
        PartDefinition leftLeg = partDefinition.addOrReplaceChild("left_leg", CubeListBuilder.create(), PartPose.offset(4.5F, 10.5F, 0.0F));
        leftLeg.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(38, 53).mirror().addBox(-2.85F, 1.5F, -2.55F, 3.0F, 5.0F, 5.0F, new CubeDeformation(-0.003F)).mirror(false)
                .texOffs(38, 53).mirror().addBox(-2.6F, -1.5F, -2.55F, 3.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

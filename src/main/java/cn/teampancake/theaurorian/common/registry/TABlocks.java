...
public class TABlocks {
    ...
    public static final DeferredHolder<Block, LiquidBlock> MOLTEN_AURORIAN_STEEL = registerNoItemBuilder("molten_aurorian_steel", p -> new LiquidBlock(TAFluids.MOLTEN_AURORIAN_STEEL_STILL.get(), ofFullCopy(Blocks.LAVA))).register();
    ...
    public static final DeferredHolder<Block, Block> AURORIAN_STEEL_CASTLE_RUNE_STONE = runestoneBuilder("aurorian_steel_castle_rune_stone", of()).tag(TABlockTags.RUNE_STONE_BLOCK).defaultBlockstate().register();
    ...
    public static final DeferredHolder<Block, Block> AURORIAN_STEEL_BLOCK = simpleBuilder("aurorian_steel_block", defaultStoneProperties(5.0F).mapColor(MapColor.METAL)).tag(BlockTags.MINEABLE_WITH_PICKAXE, BlockTags.NEEDS_IRON_TOOL).defaultLoot().register();
    ...
    public static final DeferredHolder<Block, VerticalStairBlock> VERTICAL_AURORIAN_STEEL_CASTLE_RUNE_STONE_STAIRS = verticalStair("vertical_aurorian_steel_castle_rune_stone_stairs", AURORIAN_STEEL_CASTLE_RUNE_STONE, runestoneProperties()).tag(TABlockTags.DUNGEON_BLOCKS).register();
    ...
    public static final DeferredHolder<Block, VerticalSlabBlock> VERTICAL_AURORIAN_STEEL_CASTLE_RUNE_STONE_SLAB = verticalSlab("vertical_aurorian_steel_castle_rune_stone_slab", AURORIAN_STEEL_CASTLE_RUNE_STONE, runestoneProperties()).tag(TABlockTags.DUNGEON_BLOCKS).register();
    ...
    public static final DeferredHolder<Block, StairBlock> AURORIAN_STEEL_CASTLE_RUNE_STONE_STAIRS = stair("aurorian_steel_castle_rune_stone_stairs", AURORIAN_STEEL_CASTLE_RUNE_STONE, runestoneProperties()).tag(TABlockTags.DUNGEON_BLOCKS).register();
    ...
    public static final DeferredHolder<Block, StairBlock> LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_STAIRS = stair("luminous_aurorian_steel_castle_rune_stone_stairs", AURORIAN_STEEL_CASTLE_RUNE_STONE, runestoneProperties(), TAFeatureFlags.EMISSIVITY).tag(TABlockTags.DUNGEON_BLOCKS).register();
    ...
    public static final DeferredHolder<Block, SlabBlock> AURORIAN_STEEL_CASTLE_RUNE_STONE_SLAB = slab("aurorian_steel_castle_rune_stone_slab", AURORIAN_STEEL_CASTLE_RUNE_STONE, runestoneProperties()).tag(TABlockTags.DUNGEON_BLOCKS).register();
    ...
    public static final DeferredHolder<Block, SlabBlock> LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_SLAB = slab("luminous_aurorian_steel_castle_rune_stone_slab", AURORIAN_STEEL_CASTLE_RUNE_STONE, runestoneProperties(), TAFeatureFlags.EMISSIVITY).tag(TABlockTags.DUNGEON_BLOCKS).register();
    ...
    public static final DeferredHolder<Block, WallBlock> AURORIAN_STEEL_CASTLE_RUNE_STONE_WALL = wall("aurorian_steel_castle_rune_stone_wall", AURORIAN_STEEL_CASTLE_RUNE_STONE, runestoneProperties()).tag(TABlockTags.DUNGEON_BLOCKS).register();
    ...
    public static final DeferredHolder<Block, WallBlock> LUMINOUS_AURORIAN_STEEL_CASTLE_RUNE_STONE_WALL = wall("luminous_aurorian_steel_castle_rune_stone_wall", AURORIAN_STEEL_CASTLE_RUNE_STONE, runestoneProperties(), TAFeatureFlags.EMISSIVITY).tag(TABlockTags.DUNGEON_BLOCKS).register();
